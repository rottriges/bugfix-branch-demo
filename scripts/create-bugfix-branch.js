...
async function run() {
  ...
  const newBranchName = `${newVersion}_bugFix`;

  console.log(`📦 Aktuelle Version: ${currentVersion}`);
  console.log(`🔧 Neue Bugfix-Version: ${newVersion}`);
